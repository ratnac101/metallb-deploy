pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/ratnac101/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('chhetrrb-225')   // <---- Change this to match your kubernetes cluster credentials
    }
